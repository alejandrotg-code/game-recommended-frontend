export default function Header({ activePage, setActivePage }) {
  return (
    ...
    <header className="w-full max-w-7xl mx-auto px-6 py-4 flex items-center justify-between border-b border-brand-border backdrop-blur-md sticky top-0 z-50">
      ...
      >
        ...
        <span className="text-xl font-extrabold tracking-tight text-slate-50">
          Game Recommended <span className="text-blue-400">AI</span>
        </span>
      </button>

      {/* 3. MENÚ DE ENLACES (Centro) - Se oculta en móvil (hidden) y aparece en pantallas grandes (md:flex) */}
      ...
      <div className="flex items-center gap-6">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 border border-brand-border bg-slate-900/50 px-4 py-2 rounded-xl text-sm font-semibold text-slate-200 hover:bg-slate-800 hover:text-white transition-all shadow-sm"
        >
