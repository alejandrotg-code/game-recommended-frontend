 ...
 * @returns {Promise<Array>} Lista de juegos recomendados o sugeridos.
 */
 ...
 */
export async function analyzeGame(gameId, limit = 30) {
  const response = await fetch(`${API_BASE_URL}/api/analyze/${gameId}?limit=${limit}`);
